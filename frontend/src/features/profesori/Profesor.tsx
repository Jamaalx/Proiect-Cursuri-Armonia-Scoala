...
export default function Profesor() {
  ...
  return (
    <div className="relative">
      ...
      <div className='md:container rounded-xl shadow-xl p-8 gap-10 flex flex-col md:flex-row md:mx-auto my-10'>
        <div className='flex flex-col items-center'>
          <div>
            <img src="./images/ann-doley2.png" alt="" className='w-[243px] h-[243px]' />
        ...
        <div className="flex flex-col flex-1">
          <div className="flex flex-col gap-4 mb-6">
            <p className="text-blue-text-primary text-2xl font-saint">MELVIN WARNER</p>
            <p className='text-green-secondary text-sm'>Teacher</p>
            <p className="text-[#333931] leading-9">Tempor orci dapibus ultrices in iaculis nunc sed augue. Feugiat in ante metus dictum at
            ...
            <p className="text-blue-text-primary text-2xl font-saint">Expertise & Skills:</p>
      ...
      <div className="relative md:container md:mx-auto">
        ...
        >
          ...
          {/* NAVIGATION BUTTONS */}
          <div className="custom-prev absolute top-1/2 left-2 md:left-20 transform -translate-y-1/2 z-50 cursor-pointer">
          ...
          <div className="custom-next absolute top-1/2 right-2 md:right-20 transform -translate-y-1/2 z-10 cursor-pointer">
            <div className="group w-10 h-10 flex items-center justify-center bg-white rounded-full shadow hover:bg-green-secondary transition">
              <span className="text-2xl text-teal-600 group-hover:text-white">
                <FiChevronRight />
              </span>
