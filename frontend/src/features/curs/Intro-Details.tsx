          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-2">
              <div className="relative text-[#E6E6E6]">
                ...
                <p className="~text-3xl/5xl font-bold font-epilogue text-nowrap">1420 €</p>
              </div>
              <div>
                <p className="~text-3xl/5xl font-bold font-epilogue text-green-secondary text-nowrap">1200 €</p>
              </div>
            </div>
            ...
            <div className="mb-4 mt-2">
              <div className="flex gap-8 mt-4 lg:mt-0">
                <div className=" flex ~gap-1/4 items-center">
                  ...
                  <p className="text-[#4D5756] ~text-xs/md text-nowrap">Martie 28, 2025</p>
                </div>
                <div className=" flex ~gap-1/4 items-center">
                  <img src="./images/green-file.png" alt="" className="w-4 h-5" />
                  <p className="text-[#4D5756] ~text-xs/md text-nowrap">10 sesiuni</p>
                </div>
              </div>
      ...
      <div className="md:container md:mx-auto flex flex-col xl:flex-row font-sora mx-2 mb-8">
        <div className="flex flex-col mx-4">
          ...
          <div className="flex flex-col gap-6 ~mb-2/6">
            ...
            <p className="text-[#333931] ~text-xs/lg ~leading-2/9">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
          ...
          <div className="flex flex-col gap-6 mb-6">
            ...
            <p className="text-[#333931] ~text-xs/lg ~leading-2/9">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
